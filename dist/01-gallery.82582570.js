...
var galleryList = document.querySelector('div.gallery');

var galleryCards = _galleryItems.galleryItems.map(createGalleryCard).join('');

galleryList.insertAdjacentHTML('afterbegin', galleryCards);

function createGalleryCard(_ref) {
  var description = _ref.description,
      preview = _ref.preview,
      original = _ref.original;
  return "\n    <a class=\"gallery__item\" href=\"".concat(original, "\">\n        <img class=\"gallery__image\" src=\"").concat(preview, "\" alt=\"").concat(description, "\" />\n    </a>\n    ");
}

;
var gallerySlider = new _simplelightbox.default('.gallery a', {
  captionsData: "alt",
  captionDelay: 250
});
